...
public class Demo {
    public static void main(String[] args) {
        ...
        // Build renderers (Bridge)
        Renderer hw = new HardwareRenderer();
        Renderer sw = new SoftwareRenderer();



        // Create concrete media player (Bridge abstraction)
        ...
        player.playSource(cachedRemote); // proxy triggers cache
